...
<head>
    ...
    <title>Добавяне в - КАТЕГОРИИ</title>
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="widget-content widget-content-area">
                                            <div class="custom-file-container" data-upload-id="add-category">
                                        ...
                                        <input type="text" class="form-control mb-4" id="formGroupExampleInput" name="name">
                                        <button type="submit" name="add_brand" class="btn btn-primary">Добави</button>
                                    </div>
                                </form>
                                </div>
                            </div>

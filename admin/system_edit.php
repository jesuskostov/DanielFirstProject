...
<?php
	...
	$result_product = $mysqli->query("SELECT * FROM multisplit_systems WHERE brand = '$brand'") or die($mysqli->error);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body data-spy="scroll" data-target="#navSection" data-offset="100">
                    ...
                    <div class="row layout-top-spacing">
                        <?php while ($row = $result_product->fetch_assoc()):?>
                            <div class="col-lg-6 mb-4">
                                <a href="system_edit_2.php?id=<?php echo $row['id'] ?>" style="display: contents">
                                    <div class="am-item h-100 pb-0 d-flex flex-column">
                                        ...
                                        <div class="product-details">
                                            ...
                                            <p><strong>Модел:</strong>  <?php echo $row['body_outer'] ?></p>
                                            <p><strong>Тип:</strong>  <?php echo $row['body_inner_quantity'] ?></p>
                                            <p><strong>Гаранция:</strong>  <?php echo $row['warranty'] ?></p>
    ...
    <script>
        ...
        function takeBrand() {
            let newUrl = 'system_edit.php?brand=' + $('#brand-select').val()
